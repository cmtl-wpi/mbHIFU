#!/usr/bin/env python3
#
# /home/dgvacarevelo/MFC/tests/A5B196F9/case.py:
# 3D -> Acoustic Source -> Transducer Array -> support=11 -> One element

import json
import argparse

parser = argparse.ArgumentParser(
    prog="/home/dgvacarevelo/MFC/tests/A5B196F9/case.py",
    description="/home/dgvacarevelo/MFC/tests/A5B196F9/case.py: 3D -> Acoustic Source -> Transducer Array -> support=11 -> One element",
...
case = {
    ...
    "acoustic(1)%wavelength": 0.02,
    "acoustic(1)%foc_length": 0.4,
    "acoustic(1)%aperture": 0.6,
    "acoustic(1)%num_elements": 6,
    "acoustic(1)%element_polygon_ratio": 0.7,
    "acoustic(1)%element_on": 1
}
mods = {}
