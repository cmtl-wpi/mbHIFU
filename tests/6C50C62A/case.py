#!/usr/bin/env python3
#
# /home/dgvacarevelo/MFC/tests/6C50C62A/case.py:
# 1D -> 1 Fluid(s) -> low_Mach=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="/home/dgvacarevelo/MFC/tests/6C50C62A/case.py",
    description="/home/dgvacarevelo/MFC/tests/6C50C62A/case.py: 1D -> 1 Fluid(s) -> low_Mach=2",
