#!/usr/bin/env python3
#
# /home/dgvacarevelo/MFC/tests/54B3638A/case.py:
# 2D -> 2 Fluid(s) -> low_Mach=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="/home/dgvacarevelo/MFC/tests/54B3638A/case.py",
    description="/home/dgvacarevelo/MFC/tests/54B3638A/case.py: 2D -> 2 Fluid(s) -> low_Mach=2",
