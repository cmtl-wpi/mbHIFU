#!/usr/bin/env python3
#
# /home/dgvacarevelo/MFC/tests/5A521C3F/case.py:
# 2D -> mixlayer_perturb
...
parser = argparse.ArgumentParser(
    prog="/home/dgvacarevelo/MFC/tests/5A521C3F/case.py",
    description="/home/dgvacarevelo/MFC/tests/5A521C3F/case.py: 2D -> mixlayer_perturb",
...
case = {
    ...
    "thermal": 3,
    "R0ref": 1e-05,
    "patch_icpp(1)%r0": -1000000.0,
    "patch_icpp(1)%v0": -1000000.0,
