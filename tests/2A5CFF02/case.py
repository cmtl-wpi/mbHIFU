#!/usr/bin/env python3
#
# /home/dgvacarevelo/MFC/tests/2A5CFF02/case.py:
# 1D -> weno_order=3
...
parser = argparse.ArgumentParser(
    prog="/home/dgvacarevelo/MFC/tests/2A5CFF02/case.py",
    description="/home/dgvacarevelo/MFC/tests/2A5CFF02/case.py: 1D -> weno_order=3",
