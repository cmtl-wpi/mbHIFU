#!/usr/bin/env python3
#
# tests/7DCE34B4/case.py:
# 2D -> 2 Fluid(s) -> Viscous -> IBM -> model_eqns=3

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/7DCE34B4/case.py",
    description="tests/7DCE34B4/case.py: 2D -> 2 Fluid(s) -> Viscous -> IBM -> model_eqns=3",
...
case = {
    ...
    "fluid_pp(1)%Re(1)": 0.001,
    "fluid_pp(1)%Re(2)": 0.001,
    "fluid_pp(2)%Re(1)": 0.001,
