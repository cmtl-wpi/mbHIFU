#!/usr/bin/env python3
#
# /home/dgvacarevelo/MFC/tests/F69591FE/case.py:
# 3D -> 1 Fluid(s) -> low_Mach=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="/home/dgvacarevelo/MFC/tests/F69591FE/case.py",
    description="/home/dgvacarevelo/MFC/tests/F69591FE/case.py: 3D -> 1 Fluid(s) -> low_Mach=2",
