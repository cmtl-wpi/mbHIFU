#!/usr/bin/env python3
#
# /home/dgvacarevelo/MFC/tests/F9EB7B49/case.py:
# 2D -> Bubbles -> bubble_model=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="/home/dgvacarevelo/MFC/tests/F9EB7B49/case.py",
    description="/home/dgvacarevelo/MFC/tests/F9EB7B49/case.py: 2D -> Bubbles -> bubble_model=2",
