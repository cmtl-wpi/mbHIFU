#!/usr/bin/env python3
#
# tests/B0CE19C5/case.py:
# 2D -> 1 Fluid(s) -> Viscous -> IBM -> model_eqns=3

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/B0CE19C5/case.py",
    description="tests/B0CE19C5/case.py: 2D -> 1 Fluid(s) -> Viscous -> IBM -> model_eqns=3",
