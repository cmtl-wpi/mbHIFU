#!/usr/bin/env python3
#
# /home/dgvacarevelo/MFC/tests/6BCA8356/case.py:
# 2D -> 1 Fluid(s) -> low_Mach=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="/home/dgvacarevelo/MFC/tests/6BCA8356/case.py",
    description="/home/dgvacarevelo/MFC/tests/6BCA8356/case.py: 2D -> 1 Fluid(s) -> low_Mach=2",
