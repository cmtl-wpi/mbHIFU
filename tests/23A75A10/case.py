#!/usr/bin/env python3
#
# /home/dgvacarevelo/MFC/tests/23A75A10/case.py:
# 1D -> 2 Fluid(s) -> low_Mach=1

import json
import argparse

parser = argparse.ArgumentParser(
    prog="/home/dgvacarevelo/MFC/tests/23A75A10/case.py",
    description="/home/dgvacarevelo/MFC/tests/23A75A10/case.py: 1D -> 2 Fluid(s) -> low_Mach=1",
