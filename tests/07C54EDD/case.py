#!/usr/bin/env python3
#
# /home/dgvacarevelo/MFC/tests/07C54EDD/case.py:
# 3D -> Viscosity -> Bubbles -> QBMM -> bubble_model=3 -> cfl_adap_dt=T

import json
import argparse

parser = argparse.ArgumentParser(
    prog="/home/dgvacarevelo/MFC/tests/07C54EDD/case.py",
    description="/home/dgvacarevelo/MFC/tests/07C54EDD/case.py: 3D -> Viscosity -> Bubbles -> QBMM -> bubble_model=3 -> cfl_adap_dt=T",
