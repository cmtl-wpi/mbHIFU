#!/usr/bin/env python3
#
# /home/dgvacarevelo/MFC/tests/6B1AD553/case.py:
# 2D -> Viscosity -> Bubbles -> QBMM -> bubble_model=3 -> cfl_const_dt=T

import json
import argparse

parser = argparse.ArgumentParser(
    prog="/home/dgvacarevelo/MFC/tests/6B1AD553/case.py",
    description="/home/dgvacarevelo/MFC/tests/6B1AD553/case.py: 2D -> Viscosity -> Bubbles -> QBMM -> bubble_model=3 -> cfl_const_dt=T",
