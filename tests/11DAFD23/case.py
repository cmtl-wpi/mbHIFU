#!/usr/bin/env python3
#
# /home/dgvacarevelo/MFC/tests/11DAFD23/case.py:
# 1D -> Bubbles -> nb=1
...
parser = argparse.ArgumentParser(
    prog="/home/dgvacarevelo/MFC/tests/11DAFD23/case.py",
    description="/home/dgvacarevelo/MFC/tests/11DAFD23/case.py: 1D -> Bubbles -> nb=1",
