#!/usr/bin/env python3
#
# /home/dgvacarevelo/MFC/tests/B3E70A3A/case.py:
# 1D -> weno_order=5 -> mp_weno=T

import json
import argparse

parser = argparse.ArgumentParser(
    prog="/home/dgvacarevelo/MFC/tests/B3E70A3A/case.py",
    description="/home/dgvacarevelo/MFC/tests/B3E70A3A/case.py: 1D -> weno_order=5 -> mp_weno=T",
