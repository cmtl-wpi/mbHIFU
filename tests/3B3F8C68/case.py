#!/usr/bin/env python3
#
# /home/dgvacarevelo/MFC/tests/3B3F8C68/case.py:
# 1D -> Bubbles -> adv_n=T -> adap_dt=T

import json
import argparse

parser = argparse.ArgumentParser(
    prog="/home/dgvacarevelo/MFC/tests/3B3F8C68/case.py",
    description="/home/dgvacarevelo/MFC/tests/3B3F8C68/case.py: 1D -> Bubbles -> adv_n=T -> adap_dt=T",
