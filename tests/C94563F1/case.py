#!/usr/bin/env python3
#
# /home/dgvacarevelo/MFC/tests/C94563F1/case.py:
# 2D -> 2 Fluid(s) -> low_Mach=1

import json
import argparse

parser = argparse.ArgumentParser(
    prog="/home/dgvacarevelo/MFC/tests/C94563F1/case.py",
    description="/home/dgvacarevelo/MFC/tests/C94563F1/case.py: 2D -> 2 Fluid(s) -> low_Mach=1",
