#!/usr/bin/env python3
#
# /home/dgvacarevelo/MFC/tests/BDE56A04/case.py:
# 1D -> 2 Fluid(s) -> low_Mach=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="/home/dgvacarevelo/MFC/tests/BDE56A04/case.py",
    description="/home/dgvacarevelo/MFC/tests/BDE56A04/case.py: 1D -> 2 Fluid(s) -> low_Mach=2",
