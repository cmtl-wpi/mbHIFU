#!/usr/bin/env python3
#
# /home/dgvacarevelo/MFC/tests/37FA2CEF/case.py:
# 1D -> Viscosity -> Bubbles -> QBMM -> bubble_model=3 -> cfl_const_dt=T

import json
import argparse

parser = argparse.ArgumentParser(
    prog="/home/dgvacarevelo/MFC/tests/37FA2CEF/case.py",
    description="/home/dgvacarevelo/MFC/tests/37FA2CEF/case.py: 1D -> Viscosity -> Bubbles -> QBMM -> bubble_model=3 -> cfl_const_dt=T",
