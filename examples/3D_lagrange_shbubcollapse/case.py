...
patm = 1.e+05       # Atmospheric pressure - Pa
pamp = 1.32e+05     # Amplitude of the acoustic source - Pa
freq = 21.4e+03     # Source frequency - Hz
wlen = c_host/freq  # Wavelength - m

# Domain and time set up

xb = -6.e-3    # Domain boundaries - m (x direction)
xe = 6.e-3
