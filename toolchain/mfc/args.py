...
started, run ./mfc.sh build -h.""",
    ...
    run.add_argument("-p", "--partition",          metavar="PARTITION",          type=str, default="short",         help="(Batch) Partition for job submission.")
    ...
    run.add_argument("-w", "--walltime",           metavar="WALLTIME",           type=str, default="24:00:00", help="(Batch) Walltime.")
