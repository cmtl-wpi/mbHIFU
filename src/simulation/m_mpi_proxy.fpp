...
contains
    ...
    impure subroutine s_mpi_bcast_user_inputs()
        ...
        #:for VAR in [ 'run_time_info','cyl_coord', 'mpp_lim',     &
            ...
            & 'hyper_cleaning', 'ib_state_wrt', 'hifu']
        ...
        do i = 1, num_fluids_max
            ! #:for VAR in [ 'gamma','pi_inf','mul0','ss','pv','gamma_v','M_v', & & 'mu_v','k_v', 'cp_v','G', 'cv', 'qv',
            ! 'qvp','rho_cp', 'tdiff', 'absCoef' ]
            #:for VAR in [ 'gamma','pi_inf','G','cv','qv','qvp','rho_cp', 'tdiff', 'absCoef' ]
        ...
        if (bubbles_euler .or. bubbles_lagrange) then
            #:for VAR in [ 'R0ref','p0ref','rho0ref','T0ref', &
                ...
                'M_v','M_g','k_v','k_g','cp_v','cp_g','R_v','R_g','Thost']
