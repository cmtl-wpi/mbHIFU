...
contains
    ...
    subroutine s_check_inputs
        ...
        if (hifu) call s_check_inputs_hifu
    ...
    subroutine s_check_inputs_hifu
        @:PROHIBIT(hifu_intensityFlag .and. hifu_heateqnFlag, "Unsupported HIFU flags. IntensityFlag and heatEqnFlag cannot be both true.")
        @:PROHIBIT(p>0 .or. .not. cyl_coord, "HIFU works in axisymmetric mode only.")
        @:PROHIBIT (hifu_heateqnFlag .and. particleflag, "particleflag must be False when solving bioheat HIFU")
