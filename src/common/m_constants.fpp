...
module m_constants
    ...
    integer, parameter :: dflt_adap_dt_max_iters = 1000000 !< Default max iteration for adaptive step size
    ...
    ! integer, parameter :: BC_ROT_PERIODIC = -22     !Rotational periodic boundary
