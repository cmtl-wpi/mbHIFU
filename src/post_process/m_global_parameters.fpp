...
module m_global_parameters
    ...
    type(acoustic_bc_parameters)                :: acoustic_bc_params
...
contains
    ...
    impure subroutine s_initialize_global_parameters_module
        ...
        ! momxb = mom_idx%beg momxe = mom_idx%end advxb = adv_idx%beg advxe = adv_idx%end contxb = cont_idx%beg contxe =
        ! cont_idx%end bubxb = bub_idx%beg bubxe = bub_idx%end strxb = stress_idx%beg strxe = stress_idx%end intxb =
        ! internalEnergies_idx%beg intxe = internalEnergies_idx%end xibeg = xi_idx%beg xiend = xi_idx%end chemxb = species_idx%beg
